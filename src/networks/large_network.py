'''Implementation of larger neural networks for PPO'''
...
class SimpleActorNetwork(Network):
    ...
    def __init__(self,
        ...
        dense_layer1 = keras.layers.Dense(30, activation="relu")(input_layer)
        dense_layer2 = keras.layers.Dense(15, activation="relu")(dense_layer1)
        dense_layer3 = keras.layers.Dense(15, activation="relu")(dense_layer2)
